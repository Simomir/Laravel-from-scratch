...
<header id="header" class="skel-layers-fixed">
    <h1><a href="{{ route('index') }}">HTML5 Website <span>by Html5webtemplates.co.uk</span></a></h1>
    <nav id="nav">
        <ul>
            ...
            <li><a href="{{ route('layout') }}">Elements</a></li>
        </ul>
    </nav>
</header>
    ...
    <div class="container">
        <div class="row 150%">
            ...
            <div class="8u 12u$(2) important(2)">
                ...
                <!-- Content -->
                <section id="content">
                    <a href="#" class="image fit"><img src="{{ asset('images/slide02.jpg') }}" alt="" /></a>
